...
export QUANTIZED_MODEL_PATH=../PV-GPTQ/Tiny-llama-4bit # path to the model created by initial calibration
export TOKENIZED_DATASET_PATH=../PV-GPTQ/pajama_tokenized_tinyllama  # yet again, red pajama adviced
export CACHE_DIR=../PV-GPTQ/cache_dir
export SNAPSHOT_PATH=../PV-GPTQ/pv_model
export SEQLEN=4096
export NUM_GPUS=4
